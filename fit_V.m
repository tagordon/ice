...
Vc=linspace(0.8*V_bound(1),1.2*V_bound(2),1000); 
Tc=linspace(0,T_max,10);
...
%title("Cp input to Gibbs fit")
%subplot(1, 3, 2)
%plot3(Pg*1e-3, Tg, out.Cp, 'ko','MarkerFaceColor','k','MarkerSize',3);
